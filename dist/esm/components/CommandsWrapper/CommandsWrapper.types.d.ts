 ...
 */
export declare function keyboardShortcut(altKey: boolean, shiftKey: boolean, key: string): KeyboardShortcut;
/**
 * Initialize a keyboard shortcut with no modifiers except Ctrl (Command).
 * @param key - The key.
 */
export declare function noModifiersShortcut(key: string): KeyboardShortcut;
/**
 ...
 * @returns The command.
 */
export declare function command(name: string, keywords: string[], shortcut: KeyboardShortcut, action: () => void, isDestructive?: boolean): Command;
/**
 ...
 */
export declare function commandsGroup(name: string, commands: Command[], isHidden?: boolean): CommandsGroup;
/**
